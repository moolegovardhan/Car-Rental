...
public class ResponseMessages {
	...
	public static final String GENERALL_FETCH_SUCCESS = "Records Fetch Successfully";
	...
	public static final String GENERALL_INSERT_SUCCESS = "Record Inserted Successfully";
	public static final String GENERALL_INSERT_FAIL = "Sorry Unable to Insert Record";
	public static final String GENERALL_UPDATE_SUCCESS = "Records Updated Successfully";
	public static final String GENERALL_UPDATE_FAIL = "Sorry Unable to Update Records";
	public static final String GENERALL_DELETE_SUCCESS = "Records Deleted Successfully";
